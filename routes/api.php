...
Route::get('control', 'Dashboard\ControlController@ordersIndex');
Route::get('control/deleted', 'Dashboard\ControlController@deletedOrders');
Route::get('control/expenses', 'Dashboard\ControlController@expensesIndex');
Route::get('control/deletedExpenses', 'Dashboard\ControlController@deletedExpenses');
